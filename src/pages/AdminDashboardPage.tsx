...
export const AdminDashboardPage: React.FC = () => {
  ...
  const { apps, addApp, removeApp, editApp } = useCatalogStore();
  ...
  return (
    <div className="min-h-screen bg-telegram-light p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-telegram-background rounded-lg shadow-card p-6 mb-6">
          <h2 className="text-xl font-medium text-telegram-text mb-4">
